...
echo " "
echo "--------------------------------------------------"
echo "Testing memory with icp"
icp canister call memory change_memory '()' --environment local --identity "$ICPP_PRO_TEST_IDENTITY"
icp canister call memory print_memory '()' --environment local --identity "$ICPP_PRO_TEST_IDENTITY"
