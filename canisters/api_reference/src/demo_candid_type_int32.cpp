...
$ icp canister call demo demo_candid_type_int32 '(101 : int32)' --environment local
(101 : int32)
...
$ icp canister call demo demo_candid_type_int32s '(101 : int32, -102 : int32)' --environment local
(101 : int32, -102 : int32)
-> check the console of the local network. The canister will print:
