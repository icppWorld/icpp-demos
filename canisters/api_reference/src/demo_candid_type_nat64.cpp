...
void demo_candid_type_nat64s() {
  ...
  args_in.push_back(CandidTypeNat64(&in1));
  args_in.push_back(CandidTypeNat64(&in2));
  ...
  args_out.push_back(CandidTypeNat64(in1));
  args_out.push_back(CandidTypeNat64(in2));
