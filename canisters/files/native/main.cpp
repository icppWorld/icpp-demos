...
int main() {
  ...
  mockIC.run_test("write_read_during_query", write_read_during_query, "4449444c0000",
                  "4449444c036c02aaac8d9304018d9380e80f716d716b01bc8a0100010200030648656c6c6f200966726f6d207468652013696e7465726e616c20646174612066696c6521065f646174615f", silent_on_trap, my_principal);

  // '()' -> '(variant { Ok = record { data = vec { "Hello "; "from the "; "internal data file!";}; header = "_data_";} })'
  mockIC.run_test("write_read_during_update", write_read_during_update, "4449444c0000",
                  "4449444c036c02aaac8d9304018d9380e80f716d716b01bc8a0100010200030648656c6c6f200966726f6d207468652013696e7465726e616c20646174612066696c6521065f646174615f", silent_on_trap, my_principal);
  ...
  mockIC.run_test("file_download_chunk", file_download_chunk, "4449444c016c0393affe810678c7dda8bb0771aec3faa40b780100000000000000000012696e7465726e616c5f646174615f66696c6580841e0000000000",
