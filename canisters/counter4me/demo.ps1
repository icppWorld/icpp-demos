...
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity default counter4me  read_counter4me

Write-Host "- Write the initial state for counter of default identity:"
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity default counter4me write_counter4me '(10: nat64)'
...
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity default counter4me inc_counter4me

Write-Host "- Verify the state change of counter4me persists:"
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity default counter4me read_counter4me

Write-Host "- Write the initial state for counter of anonymous identity:"
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity anonymous counter4me write_counter4me '(10: nat64)'

Write-Host "- Verify the state change of counter4me persists:"
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity anonymous counter4me read_counter4me

Write-Host "- Increment counter for anonymous identity, using an update call:"
wsl --% . ~/.local/share/dfx/env; dfx canister call --identity anonymous counter4me inc_counter4me
