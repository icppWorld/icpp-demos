/* file: src/demo_candid_type_int16.cpp
...
void demo_candid_type_int16s() {
  ...
  args_in.push_back(CandidTypeInt16(&in1));
  args_in.push_back(CandidTypeInt16(&in2));
  ...
  args_out.push_back(CandidTypeInt16(in1));
  args_out.push_back(CandidTypeInt16(in2));
