...
$ icp canister call demo demo_candid_type_nat16 '(101 : nat16)' --environment local
(101 : nat16)
...
$ icp canister call demo demo_candid_type_nat16s '(101 : nat16, 102 : nat16)' --environment local
(101 : nat16, 102 : nat16)
-> check the console of the local network. The canister will print:
