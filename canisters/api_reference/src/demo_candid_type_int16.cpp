...
$ icp canister call demo demo_candid_type_int16 '(101 : int16)' --environment local
(101 : int16)
...
$ icp canister call demo demo_candid_type_int16s '(101 : int16, -102 : int16)' --environment local
(101 : int16, -102 : int16)
-> check the console of the local network. The canister will print:
