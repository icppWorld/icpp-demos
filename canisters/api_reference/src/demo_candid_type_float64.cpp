...
$ icp canister call demo demo_candid_type_float64 '(0.1 : float64)' --environment local
(0.1 : float64)
...
$ icp canister call demo demo_candid_type_float64s '(0.1 : float64, -1.2 : float64)' --environment local
