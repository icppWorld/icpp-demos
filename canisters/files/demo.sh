...
icp canister call files write_read_during_query '()' --environment local --identity "$ICPP_PRO_TEST_IDENTITY"
icp canister call files write_read_during_update '()' --environment local --identity "$ICPP_PRO_TEST_IDENTITY"
